% function Make_Robot_Climb_Multiple_steps(n,start,Iterations,save,ZMP_Plot)
...
for j=start:n % THIS LOP IS FOR NUMBER OF STEPS TO CLIMB
    ...
    if(rem(j,2)==0)
        [qLR2,qLR3,qLL1,qLL2,p]= Trajectory_staircase(j,0,0,p,q);
    else
        [qLL1,qLL2,qLR2,qLR3,p]= Trajectory_staircase(j,0,0,p,q);
    end
...
% IT ALSO CONTAINS THE CALCULATION OF STATIC BALANCE AND ZMP
    ...
    for i=1:p
        ...
        %PLOTTING OF THE STAIRCASE
                ...
                plot3([-200,0,0,200,200,400,400,600,600,800,800,1250,1250,1000,-200],[-50,-50,250,250,550,550,850,850,1150,1150,1450,1450,1250,1450,1450],[200,200,200,200,200,200,200,200,200,200,200,200,200,200,200],'Color','k','LineWidth',3)
                hold on;
                xlabel('X-axis')
                ylabel('Y-axis')
                zlabel('Z-axis')
                ...
                axis([-200 3500 -300 1500 -550 300])
                ...
                plot3([-200,0,0,200,200,400,400,600,600,800,800,1250,1250,1000],[-50,-50,250,250,550,550,850,850,1150,1150,1450,1450,1250,1450],[-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440],'Color','k','LineWidth',3)
                fill3([-200,0,0,200,200,400,400,600,600,800,800,-200,-200],[-50,-50,250,250,550,550,850,850,1150,1150,1450,1450,-50],[200,200,200,200,200,200,200,200,200,200,200,200,200],[0.9290 0.6940 0.1250])

                fill3([a+200 a+200 a+200 a+200 a+200],[250+b 250+b 550+b 550+b 250+b],[200,-440,-440,200,200],[1 0.2 0.2])
                 ...
                 plot3([400,400],[550,550],[200,-440],'Color','k','LineWidth',3);
                 plot3([400,400],[850,850],[200,-440],'Color','k','LineWidth',3);
                 plot3([600,600],[850,850],[200,-440],'Color','k','LineWidth',3);
                 plot3([600,600],[1150,1150],[200,-440,],'Color','k','LineWidth',3);
                 plot3([800,800],[1150,1150],[200,-440],'Color','k','LineWidth',3);
                 plot3([800,800],[1450,1450],[200,-440],'Color','k','LineWidth',3);
                 plot3([-200,-200],[-50,1450],[200,200],'Color','k','LineWidth',3);
                 for c=1:j
                    a=(c-1)*200;
                    b=(c-1)*300;
                    fill3([a a a a a],[-50+b -50+b 250+b 250+b -50+b],[200,-440,-440,200,200],[0 0.6 0.3])
                 end
                 if((i==p)&&(j==4))
                    fill3([a+200 a+200 a+200 a+200 a+200],[250+b 250+b 550+b 550+b 250+b],[200,-440,-440,200,200],[0 0.6 0.3])
                    fill3([1250,1250,1000],[1450,1250,1450],[-440,-440,-440],[0 0.6 0.3]);
                    fill3([1250,1250,1000],[1450,1250,1450],[200,200,200],[0 0.6 0.3]);
                 else
                     fill3([1250,1250,1000],[1450,1250,1450],[-440,-440,-440],[1 0.2 0.2]);
                     fill3([1250,1250,1000],[1450,1250,1450],[200,200,200],[1 0.2 0.2]);
                 end
...
if(save==1)
    T=table(Q_ALL);
        filename='JOINT_ANGLES_CLIMB_STAIRS.xls';

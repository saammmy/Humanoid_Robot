% function Make_Robot_Descend_Multiple_steps(n,start,Iterations,save,ZMP_Plot)
n=4;
start=1;
Iterations=10;
save=1;
ZMP_Plot=1;
%ZMP WILL BE PLOTTED AT EVERY STEP (PROVIDED YOU SUPPLY INPUT AS 1)
figure('units','normalized','outerposition',[0 0 1 1]) %FOR FULL SCREEN PLOT
p=Iterations;
q=linspace(0,0,p);% BODY TILT (SIDEWAYS)
for j=start:n % THIS LOP IS FOR NUMBER OF STEPS TO CLIMB
    ...
    if(rem(j,2)==0)
        [qLR2,qLR3,qLL1,qLL2,p]= Trajectory_staircase_desc(j,0,0,p,q);
    else
        [qLL1,qLL2,qLR2,qLR3,p]= Trajectory_staircase_desc(j,0,0,p,q);
    end
    
    %JOINT ANGLES
    qT=linspace(5,-20,p); %TORSO(FRONT BEND AND BACK BEND)
...
% IT ALSO CONTAINS THE CALCULATION OF STATIC BALANCE AND ZMP
    ...
    for i=1:p
        ...
        %PLOTTING OF THE STAIRCASE
               
                plot3([200,200,0,0,-200,-200,-400,-400,-600,-600,-800,-800,-350,-350,-600,-800],[-550,-250,-250,50,50,350,350,650,650,950,950,1250,1250,1050,1250,1250],[200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200],'Color','k','LineWidth',3)
                hold on;
                xlabel('X-axis')
                ylabel('Y-axis')
                zlabel('Z-axis')
                ...
                %axis([ -200 1200 -1000 1800 -1000 1000])
                %axis([-500 1750 -200 650 -250 300])
                %axis([-200 3400 -300 1500 -1000 1000])
                axis([-800 2900 -550 1250 -550 300])
                ...
                plot3([200,200,0,0,-200,-200,-400,-400,-600,-600,-800,-800,-350,-350,-600,-800],[-550,-250,-250,50,50,350,350,650,650,950,950,1250,1250,1050,1250,1250],[-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440,-440],'Color','k','LineWidth',3)
                fill3([200,200,0,0,-200,-200,-400,-400,-600,-600,-800,-800,-800,200],[-550,-250,-250,50,50,350,350,650,650,950,950,1250,-550,-550],[200,200,200,200,200,200,200,200,200,200,200,200,200,200],[0.9290 0.6940 0.1250])

                fill3([a a a a a],[50+b 50+b 350+b 350+b 50+b],[200,-440,-440,200,200],[1 0.2 0.2])

                plot3([200,200],[-550,-550],[200,-440],'Color','k','LineWidth',3);
                 plot3([200,200],[-250,-250],[200,-440],'Color','k','LineWidth',3);
                 plot3([0,0],[-250,-250],[200,-440],'Color','k','LineWidth',3);
                 plot3([0,0],[50,50],[200,-440],'Color','k','LineWidth',3);
                 plot3([-200,-200],[50,50],[200,-440],'Color','k','LineWidth',3);
                 plot3([-200,-200],[350,350],[200,-440],'Color','k','LineWidth',3);
                 plot3([-400,-400],[350,350],[200,-440],'Color','k','LineWidth',3);
                 plot3([-400,-400],[650,650],[200,-440],'Color','k','LineWidth',3);
                 plot3([-600,-600],[650,650],[200,-440],'Color','k','LineWidth',3);
                 plot3([-600,-600],[950,950],[200,-440],'Color','k','LineWidth',3);
                 plot3([-800,-800],[950,950],[200,-440,],'Color','k','LineWidth',3);
                 plot3([-800,-800],[1250,1250],[200,-440],'Color','k','LineWidth',3);
                
                 for c=1:j
                    a=(c-1)*200*-1;
                    b=(c-1)*300;
                    fill3([a a a a a],[-250+b -250+b 50+b 50+b -250+b],[200,-440,-440,200,200],[0 0.6 0.3])
                 end
                 if((i==p)&&(j==4))
                    fill3([a-200 a-200 a-200 a-200 a-200],[50+b 50+b 350+b 350+b 50+b],[200,-440,-440,200,200],[0 0.6 0.3])
                    fill3([-350,-350,-600],[1250,1050,1250],[-440,-440,-440],[0 0.6 0.3]);
                    fill3([-350,-350,-600],[1250,1050,1250],[200,200,200],[0 0.6 0.3]);
                 else
                    fill3([-350,-350,-600],[1250,1050,1250],[-440,-440,-440],[1 0.2 0.2]);
                    fill3([-350,-350,-600],[1250,1050,1250],[200,200,200],[1 0.2 0.2]);
                 end
    ...
    %      qLL(6)=asind((LL6(2,4)-LR5(2,4))/186);
        ...
        LRF=LRF+0.5;
         %FOOT RECTANGLE
         fill3([LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4),LLF(1,4)],[LLF(2,4)+122.135,LLF(2,4)+122.135,LLF(2,4)+100,LLF(2,4)+80,LLF(2,4)-80,LLF(2,4)-100,LLF(2,4)-122.135,LLF(2,4)-122.135,LLF(2,4)-100,LLF(2,4)-80,LLF(2,4)+80,LLF(2,4)+100,LLF(2,4)+122.135],[LLF(3,4)+44.45,LLF(3,4)-44.45,LLF(3,4)-62.75,LLF(3,4)-44.45,LLF(3,4)-44.45,LLF(3,4)-60.15,LLF(3,4)-60.15,LLF(3,4)+60.15,LLF(3,4)+60.15,LLF(3,4)+44.45,LLF(3,4)+44.45,LLF(3,4)+62.75,LLF(3,4)+44.45],[0.25, 0.25, 0.25])
...
if(save==1)
    T=table(Q_ALL);
        filename='JOINT_ANGLES_DESC_STAIRS.xls';

function [q2R,q3R,q2L,q3L,p]= Trajectory_staircase_desc(j,showTransition,plo,p,q)
% j=2;
% showTransition=1;
% plo=1;
% p=10;
...
figure('units','normalized','outerposition',[0 0 1 1])
 plot([-550,-250,-250,50,50,350,350,650,650,950,950,1250,1250,1280,1250,1250],[200,200,0,0,-200,-200,-400,-400,-600,-600,-800,-800,-600,-650,-700,-800],'Color','k','LineWidth',3);
 axis([-1000 1800 -800 600])
hold on;
end
